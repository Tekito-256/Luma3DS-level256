...
static u32 Cheat_ApplyCheat(const Handle processHandle, CheatDescription *const cheat)
{
    ...
    while (cheat_state.index < cheat->codesCount)
    {
        ...
        case 0x0:
            ...
            if (!skipExecution)
            {
                if (!Cheat_Write32(processHandle, (arg0 & 0x0FFFFFFF), arg1))
                    return 0;
            }
            break;
        case 0x1:
            ...
            if (!skipExecution)
            {
                if (!Cheat_Write16(processHandle, (arg0 & 0x0FFFFFFF), (u16)(arg1 & 0xFFFF)))
                    return 0;
            }
            break;
        case 0x2:
            ...
            if (!skipExecution)
            {
                if (!Cheat_Write8(processHandle, (arg0 & 0x0FFFFFFF), (u8)(arg1 & 0xFF)))
                    return 0;
            }
            break;
        case 0x3:
            ...
            // Example: 323D6B28 10000000
            {
                ...
                {
                case 0x0:
                    if (!Cheat_Read32(processHandle, arg0 & 0x0FFFFFFF, &value))
                        return 0;
                    newSkip = !(value < arg1);
                    break;
                case 0x1:
        ...
        case 0x7:
            ...
            // Example: 723D6B28 00005400
            {
                ...
                {
                case 0x0:
                    if (!Cheat_Read16(processHandle, arg0 & 0x0FFFFFFF, &value))
                        return 0;
        ...
        case 0xD:
            ...
            case 0x06:
                ...
                if (!skipExecution)
                {
                    if (codeArg == 0)
                    {
                        if (!Cheat_Write32(processHandle, arg1, *activeData()))
                            return 0;
                        *activeOffset() += 4;
                    }
                    else if (codeArg == 1)
                    {
                        if (!Cheat_Write32(processHandle, arg1, cheat_state.data1))
                            return 0;
                        *activeOffset() += 4;
                    }
                    else if (codeArg == 2)
                    {
                        if (!Cheat_Write32(processHandle, arg1, cheat_state.data2))
                            return 0;
                        *activeOffset() += 4;
                    }
                }
            ...
            case 0x07:
                ...
                if (!skipExecution)
                {
                    if (codeArg == 0)
                    {
                        if (!Cheat_Write16(processHandle, arg1, (u16)(*activeData() & 0xFFFF)))
                            return 0;
                        *activeOffset() += 2;
                    }
                    else if (codeArg == 1)
                    {
                        if (!Cheat_Write16(processHandle, arg1, (u16)(cheat_state.data1 & 0xFFFF)))
                            return 0;
                        *activeOffset() += 2;
                    }
                    else if (codeArg == 2)
                    {
                        if (!Cheat_Write16(processHandle, arg1, (u16)(cheat_state.data2 & 0xFFFF)))
                            return 0;
                        *activeOffset() += 2;
                    }
                }
            ...
            case 0x08:
                ...
                if (!skipExecution)
                {
                    if (codeArg == 0)
                    {
                        if (!Cheat_Write8(processHandle, arg1, (u8)(*activeData() & 0xFF)))
                            return 0;
                        *activeOffset() += 1;
                    }
                    else if (codeArg == 1)
                    {
                        if (!Cheat_Write8(processHandle, arg1, (u8)(cheat_state.data1 & 0xFF)))
                            return 0;
                        *activeOffset() += 1;
                    }
                    else if (codeArg == 2)
                    {
                        if (!Cheat_Write8(processHandle, arg1, (u8)(cheat_state.data2 & 0xFF)))
                            return 0;
                        *activeOffset() += 1;
                    }
                }
            ...
            case 0x09:
                ...
                if (!skipExecution)
                {
                    ...
                    {
                        u32 value = 0;
                        if (!Cheat_Read32(processHandle, arg1, &value))
                            return 0;
                        *activeData() = value;
                    }
                    else if (codeArg == 1)
            ...
            case 0x0A:
                ...
                if (!skipExecution)
                {
                    ...
                    {
                        u16 value = 0;
                        if (!Cheat_Read16(processHandle, arg1, &value))
                            return 0;
                        *activeData() = value;
                    }
                    else if (codeArg == 1)
            ...
            case 0x0B:
                ...
                if (!skipExecution)
                {
                    ...
                    {
                        u8 value = 0;
                        if (!Cheat_Read8(processHandle, arg1, &value))
                            return 0;
                        *activeData() = value;
                    }
                    else if (codeArg == 1)
        ...
        case 0xE:
...

            {
                ...
                for (u32 i = 0; i < count; i++)
                {
                    ...
                    if (!skipExecution)
                    {
                        if (!Cheat_Write8(processHandle, beginOffset + i, byte))
                            return 0;
                    }
                }
